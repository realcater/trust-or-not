...
struct K {
    ...
    static let helpCrowdGameTexts = [
    "• Играем компанией, от 4 человек, телефон нужен только ведущему.\n• Ведущий озвучивает вопрос, после чего все игроки, включая вас, голосуют:\n     Согласен = Рука Поднята\n     Не согласен = Ничего",
    "• Нажимаем “\(K.showAnswerButtonText)“: кто не угадал - выбывает и больше не играет.\n• Если все ответили одинаково - нажимаем “\(K.laterButtonText)“ и вопрос задастся ещё раз на втором круге.",
    "• Если определился победитель, а вопросы остались - играем заново все вместе на оставшихся вопросах!"]
